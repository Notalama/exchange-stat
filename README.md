# Exchange stat
To run both front-end and backend servers install dependencies in exchange-stat and exchange-stat-front folders using:
```npm i```
Then in the exchange-stat run command:
```npm start```
